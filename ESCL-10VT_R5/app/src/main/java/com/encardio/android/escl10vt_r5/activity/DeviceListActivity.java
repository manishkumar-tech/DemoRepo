...
public class DeviceListActivity extends Activity {
        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            try {
                ...
                if (Constants.bluetoothService != null) {
                    ...
                    // nstants.bluetoothService = null;
                    Constants.BLUETOOTH_ADDRESS = null;
                    Constants.BLUETOOTH_DEVICE = null;
                }
                Constants.BLUETOOTH_ADDRESS_FROM_LIST = address;
                Constants.isNewBluetoothConnection = true;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (device.getBondState() != BluetoothDevice.BOND_BONDED) {
                    if (device.getName().startsWith("ESCL"))
     ...
     * @para savedInstanceState the saved instance state
     */
    @Override
